...
pub use session::{
    ...
    rsync_plain_md4_checksum, rsync_whole_file_checksum, validate_protocol_stream_prefix,
    write_multiplex_data_frame, write_rsync_i32, write_rsync_long_value, MultiplexReadState,
    MultiplexedReader, MultiplexedWriter, RemoteSessionError, RemoteShellHandshake,
    RemoteShellOperand, RemoteShellOptions, SessionError, TransferDirection,
