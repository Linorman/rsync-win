...
| Status | Options |
| --- | --- |
| Implemented | `--acls`, `--append`, `--append-verify`, `--archive`, `--atimes`, `--backup`, `--backup-dir`, `--block-size`, `--blocking-io`, `--cc`, `--checksum`, `--checksum-choice`, `--checksum-seed`, `--chmod`, `--chown`, `--compress`, `--compress-choice`, `--compress-level`, `--compress-threads`, `--compression-choice`, `--copy-devices`, `--copy-dirlinks`, `--copy-links`, `--copy-unsafe-links`, `--crtimes`, `--cvs-exclude`, `--D`, `--del`, `--delay-updates`, `--delete`, `--delete-after`, `--delete-before`, `--delete-delay`, `--delete-during`, `--delete-excluded`, `--delete-missing-args`, `--devices`, `--dirs`, `--dry-run`, `--exclude`, `--exclude-from`, `--executability`, `--existing`, `--F`, `--fake-super`, `--files-from`, `--filter`, `--force`, `--from0`, `--fsync`, `--group`, `--groupmap`, `--hard-links`, `--help`, `--human-readable`, `--ignore-errors`, `--ignore-existing`, `--ignore-missing-args`, `--ignore-non-existing`, `--ignore-times`, `--include`, `--include-from`, `--inplace`, `--ipv4`, `--ipv6`, `--itemize-changes`, `--keep-dirlinks`, `--links`, `--list-only`, `--max-delete`, `--max-size`, `--min-size`, `--mkpath`, `--modify-window`, `--munge-links`, `--no-implied-dirs`, `--numeric-ids`, `--old-args`, `--old-d`, `--old-dirs`, `--omit-dir-times`, `--omit-link-times`, `--one-file-system`, `--owner`, `--P`, `--partial`, `--partial-dir`, `--password-file`, `--perms`, `--progress`, `--protect-args`, `--recursive`, `--relative`, `--remote-option`, `--rsh`, `--rsync-path`, `--safe-links`, `--secluded-args`, `--size-only`, `--skip-compress`, `--specials`, `--stats`, `--suffix`, `--temp-dir`, `--times`, `--trust-sender`, `--update`, `--usermap`, `--verbose`, `--version`, `--whole-file`, `--write-devices`, `--xattrs`, `--zc`, `--zl`, `--zt` |
| Explicit diagnostic | none |
| Planned diagnostic | `--8-bit-output`, `--address`, `--bwlimit`, `--compare-dest`, `--contimeout`, `--copy-as`, `--copy-dest`, `--debug`, `--early-input`, `--fuzzy`, `--i-r`, `--iconv`, `--inc-recursive`, `--info`, `--link-dest`, `--log-file`, `--log-file-format`, `--max-alloc`, `--msgs2stderr`, `--no-i-r`, `--no-inc-recursive`, `--no-motd`, `--no-msgs2stderr`, `--only-write-batch`, `--open-noatime`, `--out-format`, `--outbuf`, `--port`, `--preallocate`, `--protocol`, `--prune-empty-dirs`, `--quiet`, `--read-batch`, `--remove-source-files`, `--sockopts`, `--sparse`, `--stderr`, `--stop-after`, `--stop-at`, `--super`, `--time-limit`, `--timeout`, `--write-batch` |

## Daemon And Project Options

| Scope | Implemented | Planned diagnostic |
| --- | --- | --- |
| Daemon/server | `--help`, `--verbose` | `--address`, `--bwlimit`, `--config`, `--daemon`, `--dparam`, `--ipv4`, `--ipv6`, `--log-file`, `--log-file-format`, `--no-detach`, `--port`, `--sockopts` |
