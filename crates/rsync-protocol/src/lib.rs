...
pub use session::{
    ...
    write_multiplex_data_frame, write_rsync_i32, write_rsync_long_value, CompressionAlgorithm,
    CompressionConfig, MultiplexReadState, MultiplexedReader, MultiplexedWriter,
    NegotiatedCompression, Protocol31SetupOptions, RemoteDeleteMode, RemoteSessionError,
    RemoteShellHandshake, RemoteShellOperand, RemoteShellOptions, RsyncDeflatedToken,
    RsyncDeflatedTokenMode, RsyncDeflatedTokenReader, RsyncDeflatedTokenWriter, RsyncMd4Checksum,
    SessionError, TransferDirection, REMOTE_SHELL_MODERN_PROTOCOL, REMOTE_SHELL_MVP_PROTOCOL,
};
pub use version::{
